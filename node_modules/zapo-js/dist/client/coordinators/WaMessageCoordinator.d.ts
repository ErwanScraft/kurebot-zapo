...
export declare class WaMessageCoordinator {
    ...
    private readonly trustedContactToken;
     ...
     */
    getReachoutTimelock(): Promise<WaReachoutTimelock>;
    /**
     * Fetches the per-cycle message capping info applied to new-chat threads
     * (quota, used, cycle boundaries, status flags).
     */
    getNewChatMessageCapping(type?: WaMessageCappingType): Promise<WaMessageCappingInfo>;
    /**
     ...
     * ```
     */
    send(to: string, content: WaSendMessageContent, options?: WaSendMessageOptions): Promise<WaMessagePublishResult>;
    /**
     ...
     */
    download(source: WaIncomingMessageEvent | Proto.IMessage, options?: WaDownloadMediaOptions): Promise<Readable>;
    /**
     ...
     */
    downloadToFile(source: WaIncomingMessageEvent | Proto.IMessage, filePath: string, options?: WaDownloadMediaOptions): Promise<void>;
    /**
     ...
     * short-lived.
     */
    tryDecryptAddon(event: WaIncomingMessageEvent): Promise<void>;
