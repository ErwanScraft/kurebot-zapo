...
class WaFrameCodec {
    constructor(introFrame, maxFrameLength = WA_MAX_FRAME_LENGTH) {
    ...
    encodeFrame(frame) {
        if (frame.length > this.maxFrameLength) {
            throw new Error(`frame is too large: ${frame.length} bytes (max allowed: ${this.maxFrameLength})`);
        }
...
exports.WaFrameCodec = WaFrameCodec;
