...
class WaMediaCrypto {
    ...
    static async encryptBytes(mediaType, mediaKey, plaintext, options) {
        ...
        const ciphertext = (0, primitives_1.aesCbcEncrypt)(keys.encKey, keys.iv, plaintext);
...
async function pumpDecryption(encrypted, plaintext, keys, options) {
    ...
    try {
        for await (const chunk of encrypted) {
            ...
            encHash.update(bytes);
            const merged = trailing.byteLength === 0 ? bytes : (0, bytes_1.concatBytes)([trailing, bytes]);
            if (merged.byteLength <= constants_1.HMAC_TRUNCATED_SIZE) {
                trailing = merged;
                continue;
            }
            const ciphertextChunk = merged.subarray(0, merged.byteLength - constants_1.HMAC_TRUNCATED_SIZE);
            trailing = (0, bytes_1.toBytesView)(merged.subarray(merged.byteLength - constants_1.HMAC_TRUNCATED_SIZE));
