...
const KNOWN_SERVERS = {
    [constants_1.WA_DEFAULTS.HOST_DOMAIN]: constants_1.WA_DEFAULTS.HOST_DOMAIN,
    [constants_1.WA_DEFAULTS.GROUP_SERVER]: constants_1.WA_DEFAULTS.GROUP_SERVER,
    [constants_1.WA_DEFAULTS.BROADCAST_SERVER]: constants_1.WA_DEFAULTS.BROADCAST_SERVER,
    [constants_1.WA_DEFAULTS.LID_SERVER]: constants_1.WA_DEFAULTS.LID_SERVER,
    [constants_1.WA_DEFAULTS.HOSTED_SERVER]: constants_1.WA_DEFAULTS.HOSTED_SERVER,
    [constants_1.WA_DEFAULTS.HOSTED_LID_SERVER]: constants_1.WA_DEFAULTS.HOSTED_LID_SERVER,
    [constants_1.WA_DEFAULTS.MSGR_SERVER]: constants_1.WA_DEFAULTS.MSGR_SERVER,
    [constants_1.WA_DEFAULTS.INTEROP_SERVER]: constants_1.WA_DEFAULTS.INTEROP_SERVER,
    [constants_1.WA_DEFAULTS.NEWSLETTER_SERVER]: constants_1.WA_DEFAULTS.NEWSLETTER_SERVER,
    [constants_1.WA_DEFAULTS.BOT_SERVER]: constants_1.WA_DEFAULTS.BOT_SERVER
};
/**
...
function toUserJid(jid, options = {}) {
    ...
    const server = canonicalize
        ? canonicalizeSignalServer(address.server ?? constants_1.WA_DEFAULTS.HOST_DOMAIN, options.hostDomain ?? constants_1.WA_DEFAULTS.HOST_DOMAIN)
        : address.server;
    return `${address.user}@${server}`;
}
/**
...
function isHostedDeviceJid(jid) {
    if (isJidType(jid, constants_1.WA_DEFAULTS.HOSTED_SERVER) ||
        isJidType(jid, constants_1.WA_DEFAULTS.HOSTED_LID_SERVER)) {
        return true;
    }
    const atIndex = jid.indexOf('@');
    if (atIndex < 1 || atIndex >= jid.length - 1)
