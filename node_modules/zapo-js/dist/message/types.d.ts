...
import type { WaLinkPreviewOverride } from './addons/link-preview/types';
import type { WaSendContextInfo } from './context-info';
...
type MediaFieldsFilledByBuilder = 'url' | 'mimetype' | 'fileSha256' | 'fileLength' | 'mediaKey' | 'fileEncSha256' | 'directPath' | 'mediaKeyTimestamp' | 'streamingSidecar' | 'metadataUrl' | 'contextInfo';
...
interface WaSendDocumentMessage extends WaSendMediaBase, UserMediaFields<Proto.Message.IDocumentMessage> {
    readonly type: 'document';
}
interface WaSendStickerMessage extends WaSendMediaBase, UserMediaFields<Proto.Message.IStickerMessage> {
...
type StickerPackBuilderFilled = 'stickers' | 'trayIconFileName' | 'thumbnailDirectPath' | 'thumbnailSha256' | 'thumbnailEncSha256' | 'stickerPackSize' | 'imageDataHash' | 'stickerPackOrigin';
export interface WaSendStickerPackMessage extends UserMediaFields<Omit<Proto.Message.IStickerPackMessage, StickerPackBuilderFilled | 'stickerPackId' | 'name' | 'publisher'>> {
...
export type WaSendMediaMessage = WaSendImageMessage | WaSendVideoMessage | WaSendPtvMessage | WaSendAudioMessage | WaSendDocumentMessage | WaSendStickerMessage | WaSendStickerPackMessage;
export type WaSendMessageContent = string | WaSendTextMessage | WaSendReactionMessage | WaSendRevokeMessage | WaSendPinMessage | WaSendKeepMessage | WaSendPollMessage | WaSendPollVoteMessage | WaSendEventMessage | WaSendEventResponseMessage | Proto.IMessage | WaSendMediaMessage;
