...
export declare const WA_REPORTING_TOKEN_VERSION = 2;
...
export declare function buildReportingTokenArtifacts(input: BuildReportingTokenNodeInput): Promise<BuildReportingTokenArtifactsResult | null>;
