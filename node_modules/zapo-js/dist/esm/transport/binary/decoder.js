...
import { BINARY_20, BINARY_32, BINARY_8, DICTIONARY_0, DICTIONARY_3, HEX_8, HEX_ALPHABET, JID_FB, JID_INTEROP, JID_PAIR, JID_U, JID_U_DOMAIN_TYPE_HOSTED_LID, JID_U_DOMAIN_TYPE_HOSTED_MASK, JID_U_DOMAIN_TYPE_LID, JID_U_DOMAIN_TYPE_LID_MASK, LIST_16, LIST_8, LIST_EMPTY, NIBBLE_8, NIBBLE_ALPHABET, STREAM_END } from '../binary/constants.js';
import { DICTIONARIES, SINGLE_BYTE_TOKENS } from '../binary/tokens.js';
import { TEXT_DECODER, TEXT_ENCODER, toBytesView } from '../../util/bytes.js';
...
function decodeJidU(reader) {
    ...
    let domain = WA_DEFAULTS.HOST_DOMAIN;
 ...
 */
export async function decodeBinaryNodeStanza(stanza) {
