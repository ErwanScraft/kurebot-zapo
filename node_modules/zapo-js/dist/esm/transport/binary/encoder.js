...
import { BINARY_20, BINARY_32, BINARY_8, DICTIONARY_0, DICTIONARY_TOKEN_MAPS, HEX_8, JID_PAIR, JID_U, JID_U_DOMAIN_TYPE_HOSTED, JID_U_DOMAIN_TYPE_HOSTED_LID, JID_U_DOMAIN_TYPE_LID, JID_U_DOMAIN_TYPE_PN, LIST_16, LIST_8, LIST_EMPTY, NIBBLE_8, SINGLE_BYTE_TOKEN_MAP } from '../binary/constants.js';
...
function writeString(value, writer) {
    ...
    for (let dictionaryIndex = 0; dictionaryIndex < DICTIONARY_TOKEN_MAPS.length; dictionaryIndex += 1) {
 ...
 */
export function encodeBinaryNodeStanza(node) {
    const writer = new ByteWriter();
