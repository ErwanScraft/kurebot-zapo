import { WA_DEFAULTS, WA_IQ_TYPES, WA_NODE_TAGS, WA_USYNC_CONTEXTS, WA_USYNC_DEFAULTS, WA_USYNC_MODES, WA_XMLNS } from '../../../protocol/constants.js';
import { findNodeChild, getNodeChildrenByTag } from '../../node/helpers.js';
...
export function iterateUsyncUsers(result) {
 ...
 * payload.
 */
export function parseUsyncResultEnvelope(result) {
    const usyncNode = findNodeChild(result, WA_NODE_TAGS.USYNC);
    if (!usyncNode)
...
export function buildUsyncIq(input) {
    ...
    return buildIqNode(WA_IQ_TYPES.GET, input.hostDomain ?? WA_DEFAULTS.HOST_DOMAIN, WA_XMLNS.USYNC, [
        {
