...
import { buildDeleteProfilePictureIq, buildGetDisappearingModeUsyncQueryNode, buildGetProfilePictureIq, buildGetStatusUsyncQueryNodes, buildGetTextStatusUsyncQueryNode, buildGetUsernameUsyncQueryNode, buildSetDisappearingModeIq, buildSetProfilePictureIq, buildSetStatusIq } from '../../transport/node/builders/profile.js';
...
function parseUsyncUsernames(result) {
    ...
    for (let i = 0; i < userNodes.length; i += 1) {
        ...
        const username = usernameNode && !hasUsernameError ? getNodeTextContent(usernameNode) || null : null;
