import { downloadHistoryBlob, flushPendingWrites } from '../persistence/history-blob.js';
import { decodeGroupHistoryBundle } from '../../message/kinds/group-history.js';
...
export async function runGroupHistoryBundle(deps, input) {
    try {
...
export async function processGroupHistoryBundle(deps, input) {
    ...
    const blob = await downloadHistoryBlob(deps.mediaTransfer, input.bundle, 'group-history', 'group history bundle');
