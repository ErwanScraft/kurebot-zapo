...
export async function runHistorySyncNotification(deps, notification) {
    try {
...
export async function processHistorySyncNotification(deps, notification) {
    ...
    for (const conversation of historySync.conversations) {
        ...
        const ephemeralSettingTimestamp = normalizeEphemeralSettingSeconds(longToNumber(conversation.ephemeralSettingTimestamp)) || undefined;
