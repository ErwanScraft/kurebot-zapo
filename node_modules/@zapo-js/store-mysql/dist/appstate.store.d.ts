import { type AppStateCollectionName, type WaAppStateStoreData, type WaAppStateSyncKey } from 'zapo-js/appstate';
import type { WaAppStateCollectionStateUpdate, WaAppStateCollectionStoreState, WaAppStateStore } from 'zapo-js/store';
import { BaseMysqlStore } from './BaseMysqlStore';
import type { WaMysqlStorageOptions } from './types';
export declare class WaAppStateMysqlStore extends BaseMysqlStore implements WaAppStateStore {
    constructor(options: WaMysqlStorageOptions);
    ...
    getCollectionStates(collections: readonly AppStateCollectionName[]): Promise<readonly WaAppStateCollectionStoreState[]>;
