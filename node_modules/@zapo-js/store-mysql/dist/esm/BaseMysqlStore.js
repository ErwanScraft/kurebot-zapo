...
import { ensureMysqlMigrations } from './connection.js';
import { assertSafeTablePrefix } from './helpers.js';
const DEFAULT_BATCH_INSERT_CHUNK_SIZE = 500;
const DEFAULT_SLOW_OPERATION_THRESHOLD_MS = 250;
export class BaseMysqlStore {
    constructor(options, migrationDomains) {
        ...
        const requested = resolvePositive(options.batchInsertChunkSize, DEFAULT_BATCH_INSERT_CHUNK_SIZE, 'batchInsertChunkSize');
    ...
    ensureReady() {
        ...
        if (!this.migrationPromise) {
            this.migrationPromise = ensureMysqlMigrations(this.pool, this.migrationDomains, this.tablePrefix)
                .then(() => {
